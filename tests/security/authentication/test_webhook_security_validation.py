...
class TestWebhookSecurityService:
    ...
    def test_init_with_signature_validator(self, mock_signature_validator, valid_webhook_request):
        ...
        # Test behavior: service should use the validator correctly
        ...
        mock_signature_validator.validate_request.assert_called_once_with(valid_webhook_request)
