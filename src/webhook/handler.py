...
class WebhookHandler:
    ...
    async def _open_emoji_creation_modal(
        ...
        """Open the emoji creation modal with modern UI."""
        metadata = {
        ...
        preview_text = (
            f'*Creating emoji for:* "{slack_message.text[:100]}'
        ...
        blocks = [
            ...
            },
            {
                ...
                "element": {
                    "type": "plain_text_input",
                    "action_id": "emoji_description_input",
                    "multiline": True,
                    "placeholder": {
                        "type": "plain_text",
                        "text": "A retro computer terminal with green text",
                    },
                },
            ...
            },
            {
                ...
                "elements": [
                    ...
                    },
                    {
                        ...
                        "placeholder": {"type": "plain_text", "text": "Choose detail"},
                        "initial_option": {
